...
```
However, the result of the kmeans did not gives us a good result. The value of AUC is 0.4149453. This is not a good result. Therefore, we believe that k means is not suitable for analyzing and predicting this set of data. Then, we are looking for other method. Next, we are going to perform the method called Recursive Partitioning and Regression Tree.
