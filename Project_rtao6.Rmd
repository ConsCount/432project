...
All four outcomes were imbalanced, among which `histological.type` was the most imbalanced. Only 10% of the responses were IDC. In some cases, such imbalance would cause models to learn nothing from the minority class. If our data also suffer from problems like this, we should resolve the imbalance by techniques like undersampling. However, if our models perform well enough on current data, no further action needs to be taken. 
